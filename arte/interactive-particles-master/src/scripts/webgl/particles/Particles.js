...
export default class Particles {
	...
	show(time = 1.0) {
		// reset
		TweenLite.fromTo(this.object3D.material.uniforms.uSize, time, { value: 0.5 }, { value: 1 });
		TweenLite.to(this.object3D.material.uniforms.uRandom, time, { value: 1.0 });
		TweenLite.fromTo(this.object3D.material.uniforms.uDepth, time * 1.5, { value: 10.0 }, { value: 1.0 });
